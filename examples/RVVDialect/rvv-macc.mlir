...
func.func @main() -> i32 {
  ...
  %res = rvv.vmacc %vec_c0_i32, %vec_c10_i32, %vec_c0_i32, %vl8 : vector<[8]xi32>, vector<[8]xi32>, vector<[8]xi32>, index
  
  rvv.store %res, %res_mem[%c0], %vl8 : vector<[8]xi32>, memref<20xi32>, index
  rvv.store %res, %res_mem[%c10], %vl8 : vector<[8]xi32>, memref<20xi32>, index
