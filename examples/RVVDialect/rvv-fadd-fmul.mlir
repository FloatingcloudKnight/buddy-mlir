...
func.func @main() -> i32 {
  ...
  %res_mul = rvv.fmul %load_vec_f32, %load_vec_f32, %c2, %vl8 : vector<[8]xf32>, vector<[8]xf32>, index, index
  %res_add = rvv.fadd %res_mul, %load_vec_f32, %c2, %vl8 : vector<[8]xf32>, vector<[8]xf32>, index, index
  rvv.store %res_add, %res_rsqrt_mem[%c0], %vl8 : vector<[8]xf32>, memref<20xf32>, index
