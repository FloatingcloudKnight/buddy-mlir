...
func.func @main() -> i32 {
  ...
  %load_vec0_f32 = rvv.load %mem_f32[%c10], %vl8 : memref<20xf32>, vector<[8]xf32>, index
  %res_rsqrt_mem = call @alloc_mem_f32() : () -> memref<20xf32>

  // Test rsqrt in RVV Dialect.
  %res_mul = rvv.vfmax %load_vec_f32, %load_vec0_f32, %vl8 : vector<[8]xf32>, vector<[8]xf32>, index
  rvv.store %res_mul, %res_rsqrt_mem[%c0], %vl8 : vector<[8]xf32>, memref<20xf32>, index
  %res_add = rvv.vfmin %load_vec_f32, %load_vec0_f32, %vl8 : vector<[8]xf32>, vector<[8]xf32>, index
  rvv.store %res_add, %res_rsqrt_mem[%c10], %vl8 : vector<[8]xf32>, memref<20xf32>, index
