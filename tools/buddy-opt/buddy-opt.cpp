...
void registerBatchMatMulOptimizePass8();
void registerBatchMatMulOptimizePass16();
void registerBatchMatMulOptimizePass32();
void registerBatchMatMulOptimizePass256();
void registerBatchMatMulOptimizePass128();
...
void registerPoolingNhwcMaxVectorizationPass128();
void registerPoolingNhwcMaxVectorizationPass4();
void registerPoolingNhwcMaxVectorizationPass8();
void registerPoolingNhwcMaxVectorizationPass32();
void registerPoolingNhwcMaxVectorizationPass64();
void registerConv2dNhwcFhwcVectorizationPass2();
void registerConv2dNhwcFhwcVectorizationPass4();
void registerConv2dNhwcFhwcVectorizationPass16();
void registerConv2dNhwcFhwcVectorizationPass32();
void registerConv2dNhwcFhwcVectorizationPass64();
...
int main(int argc, char **argv) {
  ...
  mlir::buddy::registerPoolingNhwcMaxVectorizationPass4();
  mlir::buddy::registerPoolingNhwcMaxVectorizationPass8();
  mlir::buddy::registerPoolingNhwcMaxVectorizationPass32();
  mlir::buddy::registerPoolingNhwcMaxVectorizationPass64();
  mlir::buddy::registerPoolingNhwcMaxVectorizationPass128();
  // Register Vectorization of Conv2D Nhwc Fhwc.
  mlir::buddy::registerConv2dNhwcFhwcVectorizationPass();
  mlir::buddy::registerConv2dNhwcFhwcVectorizationPass2();
  mlir::buddy::registerConv2dNhwcFhwcVectorizationPass4();
  mlir::buddy::registerConv2dNhwcFhwcVectorizationPass16();
  mlir::buddy::registerConv2dNhwcFhwcVectorizationPass32();
  mlir::buddy::registerConv2dNhwcFhwcVectorizationPass64();
  mlir::buddy::registerConv2dNhwcFhwcVectorizationPass128();
  ...
  mlir::buddy::registerBatchMatMulOptimizePass8();
  mlir::buddy::registerBatchMatMulOptimizePass16();
  mlir::buddy::registerBatchMatMulOptimizePass32();
  mlir::buddy::registerBatchMatMulOptimizePass256();
  mlir::buddy::registerBatchMatMulOptimizePass128();
