...
class Conv2dNhwcFhwcVectorizationPattern4 : public ConversionPattern {
public:
  explicit Conv2dNhwcFhwcVectorizationPattern4(MLIRContext *context,
  ...
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    affine::buildAffineLoopNest(
        ...
        [&](OpBuilder &builder, Location loc, ValueRange ivs) {
          Value tmp_ivs1 = builder.create<arith::MulIOp>(loc, ivs[1], strHeight);
                    ...
                    [&](OpBuilder &builder, Location loc, Value iv0,
                      ...
                      auto tmp1 = builder.create<affine::AffineForOp>(
                          ...
                          [&](OpBuilder &builder, Location loc, Value iv1,
                            ...
                            Value inputWidth =
                                builder.create<arith::AddIOp>(loc, tmp_ivs2, iv1);
...
//===----------------------------------------------------------------------===//
// Conv2dNhwcFhwcVectorizationPass4
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling max operations to mixture of
/// Arith + Vector operations.
namespace {
class Conv2dNhwcFhwcVectorizationPass4
    : public PassWrapper<Conv2dNhwcFhwcVectorizationPass4,
                         OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(Conv2dNhwcFhwcVectorizationPass4)
  StringRef getArgument() const final {
    return "conv2d-nhwc-fhwc-vectorization4";
  }
  StringRef getDescription() const final {
    return "Conv2d_Nhwc_Fhwc Vectorization4.";
  }
  Conv2dNhwcFhwcVectorizationPass4() = default;
  Conv2dNhwcFhwcVectorizationPass4(const Conv2dNhwcFhwcVectorizationPass4 &) {}
...
void Conv2dNhwcFhwcVectorizationPass4::runOnOperation() {
  ...
  patterns.add<Conv2dNhwcFhwcVectorizationPattern4>(context, vecsize);
...
void registerConv2dNhwcFhwcVectorizationPass4() {
  PassRegistration<Conv2dNhwcFhwcVectorizationPass4>();
}
} // namespace buddy
} // namespace mlir
