...
class PoolingNhwcMaxVectorizationPattern4 : public ConversionPattern {
public:
  explicit PoolingNhwcMaxVectorizationPattern4(MLIRContext *context,
                                              int64_t stripParam)
...
//===----------------------------------------------------------------------===//
// PoolingNhwcMaxVectorizationPass4
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling max operations to mixture of
/// Arith + Vector operations.
namespace {
class PoolingNhwcMaxVectorizationPass4
    : public PassWrapper<PoolingNhwcMaxVectorizationPass4,
                         OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(PoolingNhwcMaxVectorizationPass4)
  StringRef getArgument() const final {
    return "pooling-nhwc-max-vectorization4";
  }
  StringRef getDescription() const final {
    return "Pooling_Nhwc_Max vectorization4.";
  }
  PoolingNhwcMaxVectorizationPass4() = default;
  PoolingNhwcMaxVectorizationPass4(const PoolingNhwcMaxVectorizationPass4 &) {}
...
void PoolingNhwcMaxVectorizationPass4::runOnOperation() {
  ...
  patterns.add<PoolingNhwcMaxVectorizationPattern4>(context, strip);
...
void registerPoolingNhwcMaxVectorizationPass4() {
  PassRegistration<PoolingNhwcMaxVectorizationPass4>();
}
} // namespace buddy
} // namespace mlir
