...
class PoolingNhwcMaxVectorizationPattern8 : public ConversionPattern {
public:
  explicit PoolingNhwcMaxVectorizationPattern8(MLIRContext *context,
                                              int64_t stripParam)
...
//===----------------------------------------------------------------------===//
// PoolingNhwcMaxVectorizationPass8
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling max operations to mixture of
/// Arith + Vector operations.
namespace {
class PoolingNhwcMaxVectorizationPass8
    : public PassWrapper<PoolingNhwcMaxVectorizationPass8,
                         OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(PoolingNhwcMaxVectorizationPass8)
  StringRef getArgument() const final {
    return "pooling-nhwc-max-vectorization8";
  }
  StringRef getDescription() const final {
    return "Pooling_Nhwc_Max vectorization8.";
  }
  PoolingNhwcMaxVectorizationPass8() = default;
  PoolingNhwcMaxVectorizationPass8(const PoolingNhwcMaxVectorizationPass8 &) {}
...
void PoolingNhwcMaxVectorizationPass8::runOnOperation() {
  ...
  patterns.add<PoolingNhwcMaxVectorizationPattern8>(context, strip);
...
void registerPoolingNhwcMaxVectorizationPass8() {
  PassRegistration<PoolingNhwcMaxVectorizationPass8>();
}
} // namespace buddy
} // namespace mlir
