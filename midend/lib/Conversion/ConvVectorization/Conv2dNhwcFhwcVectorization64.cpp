...
class Conv2dNhwcFhwcVectorizationPattern64 : public ConversionPattern {
public:
  explicit Conv2dNhwcFhwcVectorizationPattern64(MLIRContext *context,
...
//===----------------------------------------------------------------------===//
// Conv2dNhwcFhwcVectorizationPass64
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling max operations to mixture of
/// Arith + Vector operations.
namespace {
class Conv2dNhwcFhwcVectorizationPass64
    : public PassWrapper<Conv2dNhwcFhwcVectorizationPass64,
                         OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(Conv2dNhwcFhwcVectorizationPass64)
  StringRef getArgument() const final {
    return "conv2d-nhwc-fhwc-vectorization64";
  }
  StringRef getDescription() const final {
    return "Conv2d_Nhwc_Fhwc Vectorization64.";
  }
  Conv2dNhwcFhwcVectorizationPass64() = default;
  Conv2dNhwcFhwcVectorizationPass64(const Conv2dNhwcFhwcVectorizationPass64 &) {}
...
void Conv2dNhwcFhwcVectorizationPass64::runOnOperation() {
  ...
  patterns.add<Conv2dNhwcFhwcVectorizationPattern64>(context, vecsize);
...
void registerConv2dNhwcFhwcVectorizationPass64() {
  PassRegistration<Conv2dNhwcFhwcVectorizationPass64>();
}
} // namespace buddy
} // namespace mlir
