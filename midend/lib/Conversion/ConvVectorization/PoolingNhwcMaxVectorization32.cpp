...
class PoolingNhwcMaxVectorizationPattern32 : public ConversionPattern {
public:
  explicit PoolingNhwcMaxVectorizationPattern32(MLIRContext *context,
                                              int64_t stripParam)
...
//===----------------------------------------------------------------------===//
// PoolingNhwcMaxVectorizationPass32
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling max operations to mixture of
/// Arith + Vector operations.
namespace {
class PoolingNhwcMaxVectorizationPass32
    : public PassWrapper<PoolingNhwcMaxVectorizationPass32,
                         OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(PoolingNhwcMaxVectorizationPass32)
  StringRef getArgument() const final {
    return "pooling-nhwc-max-vectorization32";
  }
  StringRef getDescription() const final {
    return "Pooling_Nhwc_Max vectorization32.";
  }
  PoolingNhwcMaxVectorizationPass32() = default;
  PoolingNhwcMaxVectorizationPass32(const PoolingNhwcMaxVectorizationPass32 &) {}
...
void PoolingNhwcMaxVectorizationPass32::runOnOperation() {
  ...
  patterns.add<PoolingNhwcMaxVectorizationPattern32>(context, strip);
...
void registerPoolingNhwcMaxVectorizationPass32() {
  PassRegistration<PoolingNhwcMaxVectorizationPass32>();
}
} // namespace buddy
} // namespace mlir
