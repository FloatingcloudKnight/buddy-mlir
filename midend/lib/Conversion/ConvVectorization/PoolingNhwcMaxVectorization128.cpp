...
class PoolingNhwcMaxVectorizationPattern128 : public ConversionPattern {
public:
  explicit PoolingNhwcMaxVectorizationPattern128(MLIRContext *context,
                                              int64_t stripParam)
...
//===----------------------------------------------------------------------===//
// PoolingNhwcMaxVectorizationPass128
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling max operations to mixture of
/// Arith + Vector operations.
namespace {
class PoolingNhwcMaxVectorizationPass128
    : public PassWrapper<PoolingNhwcMaxVectorizationPass128,
                         OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(PoolingNhwcMaxVectorizationPass128)
  StringRef getArgument() const final {
    return "pooling-nhwc-max-vectorization128";
  }
  StringRef getDescription() const final {
    return "Pooling_Nhwc_Max vectorization128.";
  }
  PoolingNhwcMaxVectorizationPass128() = default;
  PoolingNhwcMaxVectorizationPass128(const PoolingNhwcMaxVectorizationPass128 &) {}
...
void PoolingNhwcMaxVectorizationPass128::runOnOperation() {
  ...
  patterns.add<PoolingNhwcMaxVectorizationPattern128>(context, strip);
...
void registerPoolingNhwcMaxVectorizationPass128() {
  PassRegistration<PoolingNhwcMaxVectorizationPass128>();
}
} // namespace buddy
} // namespace mlir
