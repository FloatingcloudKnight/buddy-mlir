...
class PoolingNhwcMaxVectorizationPattern64 : public ConversionPattern {
public:
  explicit PoolingNhwcMaxVectorizationPattern64(MLIRContext *context,
                                              int64_t stripParam)
...
//===----------------------------------------------------------------------===//
// PoolingNhwcMaxVectorizationPass64
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling max operations to mixture of
/// Arith + Vector operations.
namespace {
class PoolingNhwcMaxVectorizationPass64
    : public PassWrapper<PoolingNhwcMaxVectorizationPass64,
                         OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(PoolingNhwcMaxVectorizationPass64)
  StringRef getArgument() const final {
    return "pooling-nhwc-max-vectorization64";
  }
  StringRef getDescription() const final {
    return "Pooling_Nhwc_Max vectorization64.";
  }
  PoolingNhwcMaxVectorizationPass64() = default;
  PoolingNhwcMaxVectorizationPass64(const PoolingNhwcMaxVectorizationPass64 &) {}
...
void PoolingNhwcMaxVectorizationPass64::runOnOperation() {
  ...
  patterns.add<PoolingNhwcMaxVectorizationPattern64>(context, strip);
...
void registerPoolingNhwcMaxVectorizationPass64() {
  PassRegistration<PoolingNhwcMaxVectorizationPass64>();
}
} // namespace buddy
} // namespace mlir
