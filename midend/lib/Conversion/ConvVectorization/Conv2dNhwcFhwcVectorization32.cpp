...
class Conv2dNhwcFhwcVectorizationPattern32 : public ConversionPattern {
public:
  explicit Conv2dNhwcFhwcVectorizationPattern32(MLIRContext *context,
...
//===----------------------------------------------------------------------===//
// Conv2dNhwcFhwcVectorizationPass32
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling max operations to mixture of
/// Arith + Vector operations.
namespace {
class Conv2dNhwcFhwcVectorizationPass32
    : public PassWrapper<Conv2dNhwcFhwcVectorizationPass32,
                         OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(Conv2dNhwcFhwcVectorizationPass32)
  StringRef getArgument() const final {
    return "conv2d-nhwc-fhwc-vectorization32";
  }
  StringRef getDescription() const final {
    return "Conv2d_Nhwc_Fhwc Vectorization32.";
  }
  Conv2dNhwcFhwcVectorizationPass32() = default;
  Conv2dNhwcFhwcVectorizationPass32(const Conv2dNhwcFhwcVectorizationPass32 &) {}
...
void Conv2dNhwcFhwcVectorizationPass32::runOnOperation() {
  ...
  patterns.add<Conv2dNhwcFhwcVectorizationPattern32>(context, vecsize);
...
void registerConv2dNhwcFhwcVectorizationPass32() {
  PassRegistration<Conv2dNhwcFhwcVectorizationPass32>();
}
} // namespace buddy
} // namespace mlir
