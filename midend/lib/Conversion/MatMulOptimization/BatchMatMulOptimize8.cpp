...
class BatchMatMulOptimizePattern8 : public ConversionPattern {
public:
  explicit BatchMatMulOptimizePattern8(MLIRContext *context,
...
//===----------------------------------------------------------------------===//
// BatchMatMulOptimizePass8
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling operations to mixture of
/// Affine + Vector operations.
namespace {
class BatchMatMulOptimizePass8
    : public PassWrapper<BatchMatMulOptimizePass8, OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(BatchMatMulOptimizePass8)
  StringRef getArgument() const final { return "batchmatmul-optimize8"; }
  StringRef getDescription() const final { return "BatchMatMul Optimization8."; }
  BatchMatMulOptimizePass8() = default;
  BatchMatMulOptimizePass8(const BatchMatMulOptimizePass8 &) {}
  explicit BatchMatMulOptimizePass8(int64_t vecSizeParam) {
    vecSize = vecSizeParam;
  }
...
void BatchMatMulOptimizePass8::runOnOperation() {
  ...
  patterns.add<BatchMatMulOptimizePattern8>(context, vecSize);
...
void registerBatchMatMulOptimizePass8() {
  PassRegistration<BatchMatMulOptimizePass8>();
}
} // namespace buddy
} // namespace mlir
