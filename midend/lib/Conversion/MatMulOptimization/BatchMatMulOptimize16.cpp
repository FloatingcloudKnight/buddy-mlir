...
class BatchMatMulOptimizePattern16 : public ConversionPattern {
public:
  explicit BatchMatMulOptimizePattern16(MLIRContext *context,
...
//===----------------------------------------------------------------------===//
// BatchMatMulOptimizePass16
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling operations to mixture of
/// Affine + Vector operations.
namespace {
class BatchMatMulOptimizePass16
    : public PassWrapper<BatchMatMulOptimizePass16, OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(BatchMatMulOptimizePass16)
  StringRef getArgument() const final { return "batchmatmul-optimize16"; }
  StringRef getDescription() const final { return "BatchMatMul Optimization16."; }
  BatchMatMulOptimizePass16() = default;
  BatchMatMulOptimizePass16(const BatchMatMulOptimizePass16 &) {}
  explicit BatchMatMulOptimizePass16(int64_t vecSizeParam) {
    vecSize = vecSizeParam;
  }
...
void BatchMatMulOptimizePass16::runOnOperation() {
  ...
  patterns.add<BatchMatMulOptimizePattern16>(context, vecSize);
...
void registerBatchMatMulOptimizePass16() {
  PassRegistration<BatchMatMulOptimizePass16>();
}
} // namespace buddy
} // namespace mlir
