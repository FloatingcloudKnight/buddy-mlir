...
class BatchMatMulOptimizePattern256 : public ConversionPattern {
public:
  explicit BatchMatMulOptimizePattern256(MLIRContext *context,
...
//===----------------------------------------------------------------------===//
// BatchMatMulOptimizePass256
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling operations to mixture of
/// Affine + Vector operations.
namespace {
class BatchMatMulOptimizePass256
    : public PassWrapper<BatchMatMulOptimizePass256, OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(BatchMatMulOptimizePass256)
  StringRef getArgument() const final { return "batchmatmul-optimize256"; }
  StringRef getDescription() const final { return "BatchMatMul Optimization256."; }
  BatchMatMulOptimizePass256() = default;
  BatchMatMulOptimizePass256(const BatchMatMulOptimizePass256 &) {}
  explicit BatchMatMulOptimizePass256(int64_t vecSizeParam) {
    vecSize = vecSizeParam;
  }
...
void BatchMatMulOptimizePass256::runOnOperation() {
  ...
  patterns.add<BatchMatMulOptimizePattern256>(context, vecSize);
...
void registerBatchMatMulOptimizePass256() {
  PassRegistration<BatchMatMulOptimizePass256>();
}
} // namespace buddy
} // namespace mlir
